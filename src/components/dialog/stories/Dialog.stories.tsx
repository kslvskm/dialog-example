...
const longText = `
          ...
          PageMaker including versions of Lorem Ipsum. Contrary to popular belief, Lorem Ipsum is
          ...
          English versions from the 1914 translation by H. Rackham. There are many variations of
  ...
  args: {
    ...
    children: (
      <>
        ...
        <DialogContent>{longText}</DialogContent>
      </>
    ),
  },
};
...
export const PaperWithActions: Story = {
  args: {
    scroll: "paper",
    children: (
      <>
